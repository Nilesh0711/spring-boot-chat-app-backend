...
public class Chat {
    ...
    public Chat(String chat_name, String chat_image, boolean isGroup, User createdBy, Set<User> admins,
    ...
    public String toString() {
        return "Chat [id=" + id + ", chat_name=" + chat_name + ", chat_image=" + chat_image + ", isGroup=" + isGroup
                + ", createdBy=" + createdBy + ", admins=" + admins + ", users=" + users + ", messages=" + messages
                + "]";
    }
